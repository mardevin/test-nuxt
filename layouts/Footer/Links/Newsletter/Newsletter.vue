<template>
  <form class="text-left">
    ...
    <div class="social-links">
      ...
      <div class="tumblr text-white bg-normal text-center font-bold inline-block w-6 h-6 mr-2 rounded-full">
        t
      </div>
      <div class="linkedin text-white bg-normal text-center inline-block w-6 h-6 mr-2 rounded-full">
        in
      </div>
    </div>
  </form> 
